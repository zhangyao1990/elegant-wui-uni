...
结合`classPrefix`可以使用自定义图标，参见 [Icon 自定义图标](/component/pages-base/icon#自定义图标)。
...
| classPrefix            | 类名前缀，用于使用自定义图标，参见[icon](/component/pages-base/icon#自定义图标)                                                                                | string      | -                                                        | 'wui-icon'   | -        |
| button-id              | 按钮的唯一标识，可用于设置隐私同意授权按钮的 id                                                                                                                | string      | -                                                        | -            | -        |
| scope                  | 支付宝小程序使用，当 open-type 为 getAuthorize 时有效。                                                                                                        | ButtonScope | `phoneNumber` / `userInfo`                               | -            | -        |
