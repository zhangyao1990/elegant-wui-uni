...
<wui-curtain v-model="value" :src="img" :to="link"></wui-curtain>
```
...
```html
<wui-button @click="handleClick">展示幕帘</wui-button>
<wui-curtain v-model="value" :src="img" :to="link" width="280"></wui-curtain>
```
...
```html
<wui-button @click="handleClick">展示幕帘</wui-button>
<wui-curtain v-model="value" :src="img" :to="link" close-position="top" width="280"></wui-curtain>
```
...
```html
<wui-button @click="handleClick">展示幕帘</wui-button>
<wui-curtain v-model="value" :src="img" :to="link" close-position="bottom-right" width="280" close-on-click-modal></wui-curtain>
```
...
| modelValue           | 绑定值，展示/关闭幕帘                              | boolean | -                                                                        | -      | -        |
...
| ------------------ | -------------- | -------- |
| custom-class       | 根节点样式     | -        |
| custom-close-class | 关闭按钮样式类 | -        |
| custom-close-style | 关闭按钮样式   | -        |
