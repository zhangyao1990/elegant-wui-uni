...
```html
<wui-img-cropper v-model="show" :img-src="src" aspect-ratio="16:9" @confirm="handleConfirm" @cancel="handleCancel"></wui-img-cropper>
```
...
```html
<wui-img-cropper v-model="show" :img-src="src" aspect-ratio="16:10" @confirm="handleConfirm" @cancel="handleCancel"></wui-img-cropper>
```
...
| aspect-ratio        | 裁剪框宽高比，格式为 width:height                                                                                                                                                                | string          | -      | 1:1    | 0.4.0 |
