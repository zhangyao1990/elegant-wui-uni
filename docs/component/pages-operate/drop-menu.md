...
| icon-size     | 菜单图标尺寸                                                           | string                        | -      | 14px       | -        |
| before-toggle | 下拉菜单打开或者关闭前触发，`reslove(true)`时继续执行打开或关闭操作    | function({ status, resolve }) | -      | -          | -        |
...
| custom-popup-class | 自定义下拉菜单 popup 样式类 | -        |
| custom-popup-style | 自定义下拉菜单 popup 样式   | -        |
