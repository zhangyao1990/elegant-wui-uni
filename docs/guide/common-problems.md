...
`Eleagnt Wui Uni`支持深色模式、主题定制等能力，详见[ConfigProvider 全局配置](/component/pages-base/config-provider.html)组件。
...
我们为每个组件提供了`css 变量`，可以参考[config-provider](../component/pages-base/config-provider.md)组件的使用介绍来定制主题。
