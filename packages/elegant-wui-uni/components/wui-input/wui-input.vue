<template>
  <view :class="rootClass" :style="customStyle" @click="handleClick">
    <view v-if="label || $slots.label" :class="labelClass" :style="labelStyle">
      <view v-if="prefixIcon || $slots.prefix" class="wui-input__prefix">
        <wui-icon v-if="prefixIcon && !$slots.prefix" custom-class="wui-input__icon" :name="prefixIcon" @click="onClickPrefixIcon" />
    ...
    <view class="wui-input__body">
      <view class="wui-input__value">
        <view v-if="(prefixIcon || $slots.prefix) && !label" class="wui-input__prefix">
          <wui-icon v-if="prefixIcon && !$slots.prefix" custom-class="wui-input__icon" :name="prefixIcon" @click="onClickPrefixIcon" />
          <slot v-else name="prefix"></slot>
        </view>
        <input
        ...
        <view v-if="showClear || showPassword || suffixIcon || showWordCount || $slots.suffix" class="wui-input__suffix">
          ...
          <wui-icon v-if="suffixIcon && !$slots.suffix" custom-class="wui-input__icon" :name="suffixIcon" @click="onClickSuffixIcon" />
...
const rootClass = computed(() => {
  return `wui-input  ${props.label || slots.label ? 'is-cell' : ''} ${props.center ? 'is-center' : ''} ${cell.border.value ? 'is-border' : ''} ${
