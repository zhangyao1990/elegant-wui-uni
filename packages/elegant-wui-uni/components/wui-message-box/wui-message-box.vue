    ...
    >
      <view :class="rootClass">
        <view :class="bodyClass">
          <view v-if="messageState.title" class="wui-message-box__title">
            {{ messageState.title }}
          </view>
          <view class="wui-message-box__content">
            <block v-if="messageState.type === 'prompt'">
              ...
              />
              <view v-if="messageState.showErr" class="wui-message-box__input-error">
        ...
        <view :class="`wui-message-box__actions ${messageState.showCancelButton ? 'wui-message-box__flex' : 'wui-message-box__block'}`">
          <wui-button v-bind="customCancelProps" v-if="messageState.showCancelButton" @click="toggleModal('cancel')">
            {{ messageState.cancelButtonText || translate('cancel') }}
          </wui-button>
          <wui-button v-bind="customConfirmProps" @click="toggleModal('confirm')">
