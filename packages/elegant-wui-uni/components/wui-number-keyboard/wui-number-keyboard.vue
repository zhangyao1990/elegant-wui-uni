<template>
  ...
  >
    <view :class="`wui-number-keyboard ${customClass}`" :style="customStyle">
      ...
      <view class="wui-number-keyboard__body">
        <view class="wui-number-keyboard__keys">
          <wui-key v-for="key in keys" :key="key.text" :text="key.text" :type="key.type" :wider="key.wider" @press="handlePress"></wui-key>
        </view>
        <view class="wui-number-keyboard__sidebar" v-if="mode === 'custom'">
