<template>
  ...
  >
    <view class="wui-picker__field" @click="showPopup">
      ...
      <view v-else class="wui-picker__cell">
        <view
        ...
        <view class="wui-picker__body">
          <view class="wui-picker__value-wraper">
            <view :class="`wui-picker__value ${ellipsis && 'is-ellipsis'} ${customValueClass} ${showValue ? '' : 'wui-picker__placeholder'}`">
              {{ showValue ? showValue : placeholder || translate('placeholder') }}
            </view>
            <wui-icon v-if="showArrow" custom-class="wui-picker__arrow" name="arrow-right" />
            <view v-else-if="showClear" @click.stop="handleClear">
              <wui-icon custom-class="wui-picker__clear" name="error-fill" />
            </view>
          </view>
    ...
    >
      <view class="wui-picker__wraper">
        <view class="wui-picker__toolbar" @touchmove="noop">
          ...
          <view :class="`wui-picker__action ${isLoading ? 'is-loading' : ''}`" @click="onConfirm">
...
import { type ColumnItem, formatArray, type PickerViewInstance } from '../wui-picker-view/types'
