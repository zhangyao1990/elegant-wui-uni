<template>
  <view style="position: relative">
    <view :class="`wui-sticky-box ${props.customClass}`" :style="customStyle" :id="styckyBoxId">
...
const styckyBoxId = ref<string>(`wui-sticky-box${uuid()}`)
...
function handleResize(detail: any) {
  // 相对的容器大小改变后，同步设置 wui-sticky-box 的大小
  boxStyle.width = detail.width
  boxStyle.height = detail.height
  // wui-sticky-box 大小变化时，重新监听所有吸顶元素
...
/**
 *  监听容器组件
 * @param {Object} exposed wui-sticky实例暴露出的事件
