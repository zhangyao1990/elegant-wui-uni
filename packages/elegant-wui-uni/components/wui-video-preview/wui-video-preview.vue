<template>
  <view :class="`wui-video-preview ${customClass}`" :style="customStyle" v-if="showPopup" @click="close">
    <view class="wui-video-preview__video" @click.stop="">
      <video
        class="wui-video-preview__video"
    ...
    <wui-icon name="close" :custom-class="`wui-video-preview__close`" @click="close" />
  </view>
</template>

<script lang="ts">
export default {
  name: 'wui-video-preview',
  options: {
    addGlobalClass: true,
    virtualHost: true,
