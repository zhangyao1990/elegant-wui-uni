 ...
 * @Description:
 * @FilePath: \elegant-wui-uni\src\pages\img\Index.vue
 * 记得注释
-->
<template>
  <page-wraper>
...
import { joy } from '@/assets/images/joy'
import type { ImageMode } from '@/uni_modules/elegant-wui-uni/components/wui-img/types'
