...
function handleClick1() {
  uni.navigateTo({ url: '/pages-form/form/demo1' })
}

function handleClick2() {
  uni.navigateTo({ url: '/pages-form/form/demo2' })
}

function handleClick3() {
  uni.navigateTo({ url: '/pages-form/form/demo3' })
}

function handleClick4() {
  uni.navigateTo({ url: '/pages-form/form/demo4' })
}
</script>
