<template>
  <view v-if="show" :class="`wui-notice-bar ${customClass} ${noticeBarClass}`" :style="rootStyle">
    <wui-icon v-if="prefix" custom-class="wui-notice-bar__prefix" :name="prefix"></wui-icon>
    <slot v-else name="prefix"></slot>
    <view class="wui-notice-bar__wrap">
      <view class="wui-notice-bar__content" :style="animation" @transitionend="animationEnd" @click="handleClick">
    ...
    <wui-icon v-if="closable" custom-class="wui-notice-bar__suffix" name="close-bold" @click="handleClose"></wui-icon>
...
const $wrap = '.wui-notice-bar__wrap'
const $content = '.wui-notice-bar__content'
...
const noticeBarClass = computed(() => {
  ...
  if (isHorizontal.value) {
    !wrapable && !scrollable && noticeBarClasses.push('wui-notice-bar--ellipse')
  } else {
    noticeBarClasses.push('wui-notice-bar--ellipse')
  }

  wrapable && !scrollable && noticeBarClasses.push('wui-notice-bar--wrap')
