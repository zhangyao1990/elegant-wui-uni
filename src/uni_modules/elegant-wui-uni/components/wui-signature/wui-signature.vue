<template>
  <view class="wui-signature">
    <view class="wui-signature__context">
      <!-- #ifdef MP-WEIXIN -->
      <canvas
        :style="canvasStyle"
        :canvas-id="canvasId"
    ...
    <view class="wui-signature__footer">
      <slot name="footer" :clear="clear" :confirm="confirmSignature">
        <wui-button size="small" plain @click="clear">{{ clearText }}</wui-button>
        <wui-button size="small" @click="confirmSignature">{{ confirmText }}</wui-button>
      </slot>
    </view>
  </view>
</template>
