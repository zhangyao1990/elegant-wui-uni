<template>
  <view :class="rootClass" :style="rootStyle" @click="switchValue">
    <view class="wui-switch__circle" :style="circleStyle"></view>
  </view>
</template>
<script lang="ts">
export default {
...
const rootClass = computed(() => {
  return `wui-switch ${props.customClass} ${props.disabled ? 'is-disabled' : ''} ${props.modelValue === props.activeValue ? 'is-checked' : ''}`
})
