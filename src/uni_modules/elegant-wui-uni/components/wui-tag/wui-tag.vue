<template>
  <view :class="rootClass" :style="rootStyle" @click="handleClick">
    <view v-if="useIconSlot" class="wui-tag__icon">
      <slot name="icon" />
    </view>
    <wui-icon v-else-if="icon" :name="icon" custom-class="wui-tag__icon" />
    <view class="wui-tag__text" :style="textStyle">
      <slot />
    </view>
    <view class="wui-tag__close" v-if="closable && round" @click.stop="handleClose">
      <wui-icon name="error-fill" />
    </view>
    <input
      v-if="dynamicInput && dynamic"
      class="wui-tag__add-text"
    ...
    />
    <view v-else-if="dynamic" class="wui-tag__text" :style="textStyle" @click.stop="handleAdd">
      <slot name="add" v-if="$slots.add"></slot>
      <template v-else>
        <wui-icon name="add" custom-class="wui-tag__add wui-tag__icon" />
...
const rootClass = computed(() => {
  return `wui-tag ${props.customClass} ${tagClass.value}`
})
