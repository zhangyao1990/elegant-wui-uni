<template>
  <view :class="rootClass" :style="customStyle">
    <view v-if="label || $slots.label" :class="labelClass" :style="labelStyle">
      <view v-if="prefixIcon || $slots.prefix" class="wui-textarea__prefix">
        <wui-icon v-if="prefixIcon && !$slots.prefix" custom-class="wui-textarea__icon" :name="prefixIcon" @click="onClickPrefixIcon" />
...
const rootClass = computed(() => {
  return `wui-textarea   ${props.label || slots.label ? 'is-cell' : ''} ${props.center ? 'is-center' : ''} ${cell.border.value ? 'is-border' : ''} ${
